<template>
    <div class="shopcart">
      <div class="content" @click="toggleList">
        <div class="content-left">
          <div class="logo-wrapper">
            ...
            </div>                                <!-- 通过对象的形式 如果highlight为true设置highlight为false不设置highlight -->
      ...
      <transition name="fade">
        <div @click="close" class="list-mask" v-show="listShow()"></div>
      </transition>
    </div>
</template>
...
export default {
  ...
  props: ['deliveryPrice', 'minPrice', 'selectFoods'], // 这里原来接收过来的是delivery-price但是接收变量必须是是驼峰
  computed: {
    totalPrice () {
      let total = 0
  ...
  .shopcart
    ...
    .ball-container
      .ball
        ...
        transition: all 0.6s cubic-bezier(0, 0.97, 1, 0.03)
        .inner
          width: 16px
          height: 16px
          border-radius: 50%
