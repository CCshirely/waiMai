  ...
  <div>
    <div class="goods">
      <div class="menu-wrapper" ref="menu">
        <ul>
          <li class="menu-item" v-for="(item,i) in goods" :key="i" :class="{active:currentIndex===i}" @click="scrollTo(i)">
      ...
      <div class="foods-wrapper" ref="foods">
        <ul>
          <li v-for="(item,i) in goods" :key="i" class="food-list food-list-hook">
            ...
            <ul>
              <li v-for="(food,i) in item.foods" :key="i" @click="selectFood(food)" class="food-item border-1px">
                <div class="icon">
